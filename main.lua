	...
	if not shared.larpreload then
		if not shared.larpreload then
			...
			task.delay(2, function()
				larp:CreateNotification('Notifications', 'Test notification stack - 1', 5, 'info')
			end)
			task.delay(2.6, function()
				larp:CreateNotification('Notifications', 'Test notification stack - 2', 5, 'warning')
			end)
			task.delay(3.2, function()
				larp:CreateNotification('Notifications', 'Test notification stack - 3', 5, 'alert')
			end)
