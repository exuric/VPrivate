...
run(function()
	...
	-- expected third-person mesh for the held item (nil when nothing selected)
...
run(function()
	...
	local function Added(v)
		...
		dist.BackgroundColor3 = Color3.new()
		dist.BackgroundTransparency = 0.35
