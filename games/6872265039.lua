...
run(function()
	...
	RankTitle = FakeRank:CreateDropdown({
		Name = 'Rank Title',
		List = {'Nightmare', 'Emerald 4', 'Emerald 3', 'Emerald 2', 'Emerald 1', 'Diamond 4', 'Diamond 3', 'Diamond 2', 'Diamond 1', 'Platinum 4', 'Platinum 3', 'Platinum 2', 'Platinum 1', 'Gold 4', 'Gold 3', 'Gold 2', 'Gold 1', 'Silver 4', 'Silver 3', 'Silver 2', 'Silver 1', 'Bronze 4', 'Bronze 3', 'Bronze 2', 'Bronze 1'}
	})
